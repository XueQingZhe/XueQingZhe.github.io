...
order: 9
legacyUrl: /tutorials/ZZZRendering/XingJianYa(Miyabi)/UEPJ/10_添加环境光/
draft: false
---
...
![](/assets/img/ZZZRendering/Pasted%20image%2020250321152927.png)
...
![](/assets/img/ZZZRendering/Pasted%20image%2020250321153057.png)
***最终输出直接使用加法混合即可，加上漫反射和高光。因为亮度会增加可能导致高光效果不明显，所以这里将高光部分大于1的部分在加一遍对高光提亮***
![](/assets/img/ZZZRendering/Pasted%20image%2020250321153214.png)

### 当前效果

***左边是加了环境光的，右侧是没有环境光的***
![](/assets/img/ZZZRendering/Pasted%20image%2020250321153505.png)
