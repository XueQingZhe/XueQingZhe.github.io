...
tech: [PostProcess, RenderFeature, HLSL]
work: "urp-outline-feature"
---
# Bloom原理
...
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422151741.png)
...
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422153609.png)
**水平和垂直分解后，采样次数从n^2变成了2n**
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422153707.png)

## 优化版

**这里的9x5效果对应标准的9x9的高斯核**
**水平**
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422152436.png)
**垂直**
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422152334.png)

## KawaseBlur

![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422151853.png)

## DualKawaseBlur

![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422151956.png)
...
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260421194648.png)
...
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260421234045.png)
**比如BoxBlur如下**
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260421234117.png)
...
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422161718.png)

## 模糊模式

**模糊种类其实就下面这几种，没有在扩展了**
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422162511.png)
**开始是想对比blender的星芒的，但我没搞出来，去查了blender的代码，因为Blender是离线渲染，用的是ComputerShader，emmm，不会，暂时先留个坑吧，而且这个星芒效果开销比较大，属于很难用上的**
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422162417.png)
**虽然没搞出来，但是还是保留成了一个比较特别的效果，感觉有点类似近视眼看东西的感觉**
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422163043.png)

## 几种效果对比

**几种模式里面BoxBlur效果最差，KawaseBlur因为迭代次数院校，是最柔和的，高斯和DualKawaseBlur差不多，用DualKawaseBlur性能更好一点**
![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422163720.png)

![](/assets/img/MyPJ/Render%20Feature/Bloom/Pasted%20image%2020260422163536.png)
