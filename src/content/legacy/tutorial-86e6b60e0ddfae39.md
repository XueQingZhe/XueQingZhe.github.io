...
order: 1
legacyUrl: /tutorials/ZZZRendering/XingJianYa(Miyabi)/UnityPJ/02_描边追加/
draft: false
---
...
![](/assets/img/ZZZRendering/Pasted%20image%2020250104213246.png)
![](/assets/img/ZZZRendering/Pasted%20image%2020250104213416.png)
***pass内声明***
![](/assets/img/ZZZRendering/Pasted%20image%2020250104232107.png)

### Pass输入输出结构

***这里获取了模型第二套UV,里面是平滑法线数据***
![](/assets/img/ZZZRendering/Pasted%20image%2020250104232506.png)
...
![](/assets/img/ZZZRendering/Pasted%20image%2020250104233042.png)

#### 分段解析

***先进行判断是否需要描边Pass，不需要的话直接返回0***
![](/assets/img/ZZZRendering/Pasted%20image%2020250104234004.png)
***设置描边宽度***
![](/assets/img/ZZZRendering/Pasted%20image%2020250104234119.png)
***这里缩放函数使用了Colin大佬的代码***
https://github.com/ColinLeung-NiloCat/UnityURPToonLitShaderExample/blob/master/NiloOutlineUtil.hlsl
![](/assets/img/ZZZRendering/Pasted%20image%2020250104234309.png)
***法线外扩需要读取第二套UV的平滑法线信息***
![](/assets/img/ZZZRendering/Pasted%20image%2020250104234516.png)
***八面体映射读取函数***
![](/assets/img/ZZZRendering/Pasted%20image%2020250104234638.png)
***使用平滑法线后描边就不会断线了，但嘴角的线依旧有缺陷，所以需要将面部的描边向后偏移***
![](/assets/img/ZZZRendering/Pasted%20image%2020250104234824.png)
***这里需要裁剪空间下描边顶点Z轴方向偏移，代码来自于Colin大佬***
![](/assets/img/ZZZRendering/Pasted%20image%2020250104234749.png)![](/assets/img/ZZZRendering/Pasted%20image%2020250104235023.png)
...
![](/assets/img/ZZZRendering/Pasted%20image%2020250105180214.png)

#### 获取材质ID

![](/assets/img/ZZZRendering/Pasted%20image%2020250105181305.png)
***这里需要读取R通道，里面是存的材质ID***
![](/assets/img/ZZZRendering/Unagi_Body_Map1_M%201.png)
![](/assets/img/ZZZRendering/Pasted%20image%2020250105170304.png)
...
![](/assets/img/ZZZRendering/Pasted%20image%2020250105181742.png)
...
***最后进行输出***
![](/assets/img/ZZZRendering/Pasted%20image%2020250105182143.png)
![](/assets/img/ZZZRendering/Pasted%20image%2020250105182258.png)
***描边颜色x0.2压暗，除了面部为FF8181,其余先调成555555***
![](/assets/img/ZZZRendering/Pasted%20image%2020250109205430.png)
![](/assets/img/ZZZRendering/Pasted%20image%2020250109205217.png)
