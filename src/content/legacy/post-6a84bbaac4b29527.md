...
series: 我独自升级
order: 2
legacyUrl: /blog/2025/Lv.2-Unity主线-添加多光源交互/
draft: false
---
...
![图片](/assets/img/TAMonth01/Pasted%20image%2020251210193256.png)
...
![图片](/assets/img/TAMonth01/Pasted%20image%2020251210193016.png)
...
![图片](/assets/img/TAMonth01/Pasted%20image%2020251210192136.png)
***相当于额外的光照阴影***
...
![图片](/assets/img/TAMonth01/Pasted%20image%2020251212191952.png)

### FrameDebuger

**使用FrameDebuger可以看到每个光源对于每个物体Mesh都需要单独计算渲染一次，那么理所当然光源越多，消耗越大，灯光数量需要进行严格的控制，对于大场景自然不能使用前向渲染**
![图片](/assets/img/TAMonth01/%E5%89%8D%E5%90%91%E6%B8%B2%E6%9F%93%E5%A4%9A%E5%85%89%E6%BA%90%201.gif)
**同时当灯光超过规定数量时，会自动降级为顶点灯光，也就是不在片元计算，像素一般来说是比顶点多的多的，所以顶点光照质量就会非常差**
![图片](/assets/img/TAMonth01/Pasted%20image%2020251212192957.png)
...
![图片](/assets/img/TAMonth01/Pasted%20image%2020251212193424.png)

### FrameDebuger

**延迟渲染下，因为是先统一输出Guffer，然后再统一计算，所以可以看出绘制数明显降低，相当于把物体合批在绘制灯光了**
![图片](/assets/img/TAMonth01/%E5%BB%B6%E8%BF%9F%E6%B8%B2%E6%9F%93%E5%A4%9A%E5%85%89%E6%BA%90.gif)
...
![图片](/assets/img/TAMonth01/Pasted%20image%2020251212200035.png)
