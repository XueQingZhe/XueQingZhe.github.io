...
date: 2026-01-24
summary: 理论支线：PBR - 基于图像的照明( image based lighting-IBL)
tech:
  - unity
  - shader
  - rendering
...
series: 我独自升级
order: 100
legacyUrl: /blog/2026/理论支线-PBR-基于图像的照明(-image-based-lighting-IBL)/
draft: false
---
...
**使用近似后和仅处理理菲涅尔项的对比**
![](/assets/img/TAMonth02/Pasted%20image%2020260127204725.png)
