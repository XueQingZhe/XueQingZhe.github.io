...
async function setup(t, { ffmpeg = false, viewport } = {}) {
  ...
  const server = http.createServer(async (req, res) => {
    ...
    if (req.url === '/api/scan') return send({ notes: [{ path: 'Synthetic.md', id: 'synthetic', title: 'Synthetic note', status: '未生成', blocked: false }], selected: mock.selected, assets: mock.modes, missingSelected: [], ffmpeg });
