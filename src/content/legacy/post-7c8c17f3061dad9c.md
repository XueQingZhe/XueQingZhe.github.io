...
title: 平滑法线处理 - 八面体映射
date: 2026-04-01
summary: 平滑法线处理 - 八面体映射
tech: []
kind: article
series: 我独自升级
order: 100
legacyUrl: /blog/2026/平滑法线处理-八面体映射/
draft: false
---
...
**在二维中图像表示如下图**
![](/assets/img/TAMonth04/Pasted%20image%2020260314195935.png)
![](/assets/img/TAMonth04/Pasted%20image%2020260314133155.png)
...
![](/assets/img/TAMonth04/Pasted%20image%2020260314195819.png)

## 三维映射原理

**对于模型的法线向量来说，归一化后它的范围就是一个球范围，那么如果要映射到八面体上，就可以让X和Y分量除以L1范数**
![](/assets/img/TAMonth04/Pasted%20image%2020260314201825.png)

**对于Z分量，则是另有用途，前面说过八面体上下是重叠，这里就需要使用Z分量进行处理，如果是在下方，那么X分量和Y分量则需要反转或者说折叠**
![](/assets/img/TAMonth04/Pasted%20image%2020260314201506.png)
...
Y分量则是$(1-a)$，因为四条象限的法向量有正负之分，那么最终结果会取决于法向量的个分量的正负，但是这里的法向量正负正好符合象限X,Y的正负，也就是最终表达式是
...
![](/assets/img/TAMonth04/Pasted%20image%2020260314204827.png)
...
![](/assets/img/TAMonth04/Pasted%20image%2020260314230833.png)
