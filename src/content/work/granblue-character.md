...
cover: "/covers/generated/granblue-final.webp"
coverAlt: "碧蓝幻想角色最终渲染：青色星空背景中的粉发持刀角色"
engine: [Unity, URP]
tech: [NPR, Shader, HLSL]
role: [Shader]
year: 2026
glow: "#ff9a5c"
featured: true
...
***头部，身体，武器分离，动画分离。***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911213119.png)

## 贴图

***基础（默认）的一套贴图加各类不同的配色贴图***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911213247.png)
...
***颜色信息***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911215532.png)

##### A通道

***区分皮肤和非皮肤区域的Mask***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911215703.png)

#### 预览

##### RGB通道

![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911215757.png)

##### A通道

![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911215741.png)
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911215933.png)

##### A通道

***可以用于控制边缘光强度***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911220412.png)
...
***含颜色信息，相较于NRM_base贴图，亮度降低，为暗部颜色***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911220234.png)

##### A通道

![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911220154.png)
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911215356.png)

##### R通道

***高光强度信息***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911214514.png)

##### G通道

***用于偏移阴影***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911214559.png)

##### B通道

***高光范围大小，类光滑度***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911214628.png)

##### A通道

***内描边信息***
*这里的描线是作为主体，较为严格，要求横平竖直*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911214645.png)
...
***高光强度信息***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911214802.png)

##### G通道

***用于偏移阴影，因为偏移阴影有正负之分，所以选择中灰度为不偏移，小于0.5和大于0.5都会偏移***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911214822.png)

##### B通道

***高光范围大小，类光滑度***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911214839.png)

##### A通道

***内描边信息***
*这里的描线是作为主体，较为严格，要求横平竖直*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911214908.png)
...
**注意：此贴图采用第二套UV进行采样**
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911220513.png)

#### 预览

![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911220554.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911220645.png)
...
***存入了AO信息，控制遮挡关系***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911221312.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911221331.png)
...
***此通道是利用顶点色控制描边的深度***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911221643.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911221627.png)
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912094236.png)
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912094112.png)
...
*此方法控制性较低*
***阴影二值化可以使用Step函数进行实现***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912094433.png)

```c
half toon_diffuse = step(0.0, NdotL);//色阶化(阴影二值化)
```

![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912094505.png)
...
***_ToonThesHold = 0.5；
_ToonHardness = 20；时***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912100246.png)
***_ToonThesHold = 0.7；
_ToonHardness = 20；时阴影偏移***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912100440.png)
***_ToonThesHold = 0.7；
_ToonHardness = 40；时阴影边缘变硬***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912100532.png)
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912101412.png)
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912102041.png)
...
***可以看出阴影部分颜色要精细很多***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912102850.png)
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912105452.png)
***重映射***
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912110714.png)
...
***此时阴影细节更加丰富，已经达到初步效果***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912112111.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912112428.png)
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912094236.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912170719.png)
...
*NdotV结果如下：*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912172801.png)
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912173526.png)
...
*half_lambert结果如下：*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912173331.png)
*混合后spec_term结果如下：*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912174053.png)
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230912174259.png)
*1 - spec_size * _SpecSize*

![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913093215.png)
*toon_spec*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913093903.png)
***设置将要混合的高光颜色***
...
*此时高光颜色为红色*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913094231.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913094210.png)
...
*最终高光结果*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913094319.png)
...
*inner_line，内描线如下：*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913103228.png)
***使用lerp函数，白色输出依旧为白色（1,1,1），而黑色部分输出原本颜色的0.2强度，即可获得混合原本颜色的描线***
*inner_line_color如下：*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913103536.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913104642.png)
***同理对细节描写进行颜色混合***
...
*detail_map.xyz如下：
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913103702.png)
*detail_line_color如下：
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913104042.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913104608.png)
...
*final_line如下：*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913104218.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913104527.png)
...
*final_color如下：*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913105407.png)
...
*函数图如下：*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913105729.png)
***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913105706.png)
***效果预览***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913105841.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913105906.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913105928.png)
...
*此时轮廓描线如下：*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913111753.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913112244.png)
***此时描线均为同样粗细和深度，所以需要处理***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913112148.png)
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913143605.png)
...
*顶点色B通道如下：***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230911221627.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913145630.png)
...
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913163520.png)

### 最终效果

![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913163609.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913163627.png)
***脸部法线处理后效果***
*使用法线传递进行修改面部法线*
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913165824.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913165729.png)
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913165635.png)
***修改前***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913170215.png)
***修改后***
![](/assets/img/MyPJ/Granblue%20Fantasy/Pasted%20image%2020230913165507.png)
