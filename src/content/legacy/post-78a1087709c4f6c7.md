...
date: 2026-01-23
summary: Lv.3 Unity主线：视差(Parallax Mapping)
tech:
  - unity
  - shader
  - rendering
...
series: 我独自升级
order: 3
legacyUrl: /blog/2026/Lv.3-Unity主线-视差(Parallax-Mapping)/
draft: false
---
...
![](/assets/img/TAMonth02/Pasted%20image%2020260123000850.png)
...
![](/assets/img/TAMonth02/Pasted%20image%2020260123000939.png)
**2.第二种方法使用一个更好的淡出系数**
...
**指数淡出系数**
![](/assets/img/TAMonth02/Pasted%20image%2020260123192633.png)

### 自阴影

**因为要做到模型凹凸，自然会有遮挡，所以需要处理自阴影**
![](/assets/img/TAMonth02/Pasted%20image%2020260123233852.png)
