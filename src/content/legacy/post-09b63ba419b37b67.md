...
date: 2026-04-02
summary: URP - RendererFeature ：ScreenSpaceOutline
tech:
  - unity
  - shader
  - rendering
...
series: 我独自升级
order: 100
legacyUrl: /blog/2026/URP-RendererFeature-ScreenSpaceOutline/
draft: false
---
...
![](/assets/img/TAMonth04/Pasted%20image%2020260402221720.png)
...
![](/assets/img/TAMonth04/Pasted%20image%2020260403000337.png)
...
**设置参数初始化**
![](/assets/img/TAMonth04/Pasted%20image%2020260402221634.png)

## Execute()

**指定RT和Pass，因为RT不能同时读取和写入，所以要先拷贝**
![](/assets/img/TAMonth04/Pasted%20image%2020260402223608.png)
...
![](/assets/img/TAMonth04/Pasted%20image%2020260403000428.png)

## 场景深度描边

**正常情况下，如果阈值固定，深度计算出的描边会有瑕疵，过小平面会有问题**
![](/assets/img/TAMonth04/Pasted%20image%2020260403000556.png)
**过大，近处描边则会缺失**
![](/assets/img/TAMonth04/Pasted%20image%2020260403000907.png)
**这里使用深度进行适当放大阈值，可以较好解决这个问题**
![](/assets/img/TAMonth04/Pasted%20image%2020260403000922.png)

## 场景法线描边

**至于细节方面使用场景法线描边进行混合，阈值小的话还是比较乱的**
![](/assets/img/TAMonth04/Pasted%20image%2020260403001030.png)
...
**找到URP设置指定上去就行**
![](/assets/img/TAMonth04/Pasted%20image%2020260403001322.png)
