...
series: 我独自升级
order: 100
legacyUrl: /blog/2025/理论支线-PBRSpecular-GGX-速通/
draft: false
---
...
- **使用真实物理参数**：金属度(Metallic)、粗糙度(Roughness)替代传统的高光参数
 ...
 ![图片](/assets/img/TAMonth01/Pasted%20image%2020251227192945.png)
...
$$
\begin{bmatrix}\frac{\partial p}{\partial \theta} & \frac{\partial p}{\partial \phi} \end{bmatrix}
$$
...
$$
\begin{bmatrix}\sec^2(\theta) \cos(\phi) & -\tan(\theta) \sin(\phi)\end{bmatrix}
$$
...
$$
= p(p, q) \frac{dA_h / \cos^4(\theta)}{dA_h}
$$
...
## 最终结果解释
 ![图片](/assets/img/TAMonth01/Pasted%20image%2020251227192921.png)
...
# BRDF的归一化分母
1. 因子 **4**： 来源：立体角 Jacobian 变换 从微表面法线 h 到入射方向 l
