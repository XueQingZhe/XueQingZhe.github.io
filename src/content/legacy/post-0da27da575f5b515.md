...
series: 我独自升级
order: 2
legacyUrl: /blog/2025/Lv.2-Unity主线-添加环境光/
draft: false
---
...
Unity同时最多混合 2个反射探针
**场景中拖入反射探针进行烘焙然后再采样的**
![图片](/assets/img/TAMonth01/Pasted%20image%2020251215214920.png)
**如果想把某个物体烘焙到CubeMap中，需要进行设置标签**
![图片](/assets/img/TAMonth01/Pasted%20image%2020251215215013.png)
**场景默认会有一个全局反射探针，在Lighting设置中进行生成即可，就不用手动添加了，但是全局烘焙的不会含有物体，因为需要轻量化和统一，只包含天空盒SkyBox，需要烘焙物体的话还是得手动加反射探针**
![图片](/assets/img/TAMonth01/Pasted%20image%2020251215215215.png)
...
![图片](/assets/img/TAMonth01/Pasted%20image%2020251223214542.png)
