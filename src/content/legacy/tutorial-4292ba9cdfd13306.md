...
order: 0
legacyUrl: /tutorials/ZZZRendering/XingJianYa(Miyabi)/BlenderPJ/01_Blender模型处理/
draft: false
---
...
![](/assets/img/ZZZRendering/Pasted%20image%2020241230213258.png)

# 模型处理

## 导入

![](/assets/img/ZZZRendering/Pasted%20image%2020241230213609.png)

## 删除无用

***joints（关节点）和rigidbodies（刚体）***
![](/assets/img/ZZZRendering/Pasted%20image%2020241230213754.png)

## 多余材质合并

***面，齿，舌，口合并，编辑模式下材质面板点一下直接选择就行，最后选择面，点击指定***
![](/assets/img/ZZZRendering/Pasted%20image%2020241230214738.png)
***合并后物体模式下删除材质槽***
![](/assets/img/ZZZRendering/Pasted%20image%2020241230215139.png)
***眼睛合并到一起***
![](/assets/img/ZZZRendering/Pasted%20image%2020241230215327.png)
***眉毛合并到一起***
![](/assets/img/ZZZRendering/Pasted%20image%2020241230215501.png)
***眼睛高光和透贴不要删除***
![](/assets/img/ZZZRendering/Pasted%20image%2020241230215737.png)
***头发（刘海）需要拆下来，做眼睛透过头发效果***
![](/assets/img/ZZZRendering/Pasted%20image%2020241230220009.png)
***不需要分离，选出来之后直接新建一个材质头发指定上***
![](/assets/img/ZZZRendering/Pasted%20image%2020241230220736.png)
***将头发，肌肤，黑丝都合并到饰品里，然后删掉其他的***
![](/assets/img/ZZZRendering/Pasted%20image%2020241230220911.png)

## 生成一套平滑法线用于描边

***可以存在UV里面或者在定点色里面***
![](/assets/img/ZZZRendering/Pasted%20image%2020241230221247.png)
![](/assets/img/ZZZRendering/Pasted%20image%2020241230221351.png)

### 新建python脚本

***注意：mesh = bpy.data.meshes['星見雅']，这里的名称是网格体名称***
![](/assets/img/ZZZRendering/Pasted%20image%2020241230234721.png)
***因为是UV存值，所以需要将点位置从3维转换到2维，使用八面体映射***
![](/assets/img/ZZZRendering/Pasted%20image%2020250104210302.png)
...
![](/assets/img/ZZZRendering/Pasted%20image%2020241231214912.png)
![](/assets/img/ZZZRendering/Pasted%20image%2020241231214944.png)
![](/assets/img/ZZZRendering/Pasted%20image%2020241231215006.png)
***清理材质***
![](/assets/img/ZZZRendering/Pasted%20image%2020241231215143.png)
***面部一样清理一下***
![](/assets/img/ZZZRendering/Pasted%20image%2020241231215438.png)
***去除原网格体形态键***
![](/assets/img/ZZZRendering/Pasted%20image%2020241231215343.png)
***给虚幻引擎需要将模型拆分多一些，刘海拆分下来***
![](/assets/img/ZZZRendering/Pasted%20image%2020241231215833.png)

***饰品和衣服也拆分下来***
![](/assets/img/ZZZRendering/Pasted%20image%2020241231220041.png)
***因为涉及到半透明排序还有覆层材质，眼影等全部都要拆分***
![](/assets/img/ZZZRendering/Pasted%20image%2020241231220235.png)
***拆完记得重命名和清理材质***
![](/assets/img/ZZZRendering/Pasted%20image%2020241231220825.png)
